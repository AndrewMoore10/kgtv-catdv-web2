module logic
{
    ...
    export class ClipManager
    {
        ...
        {
            // validate clips
            var illegalClip = clips.find((clip) => ((clip.type != "clip") && (clip.type != "subclip")));
            if (illegalClip)
            {
        ...
        public static exportFCPXML(clips: Clip[])
        {
            ...
            var query: QueryDefinition = { name: "cliplist", terms: queryTerms };
        ...
        public static getDownloadUrl(clip: Clip, downloadOriginal: boolean, downloadProxy: boolean): string
        {
            ...
            if ((downloadOriginal && ServerSettings.canDownloadOriginals && mediaPath && clip.media.isMediaAvailable)
                || (downloadProxy && ServerSettings.canDownloadsProxies && proxyPath && (proxyPath !== mediaPath)))
            {
                ...
                url += "?download=true&type=" + (downloadOriginal && ServerSettings.canDownloadOriginals ? "orig" : "proxy");
